...
async function callGPT(title, type, lang='be', titleL=null) {
    ...
    //Prompt for city
    const baseRequest = `1. Укажыце колькасьць жыхароў населенага пункта (гарада ці вёскі) ў мільёнах, тысячах, сотнях або дзясятках чалавек, каб чытач мог уявіць яго памеры (напрыклад, '15 тыс. чал.'). 2. Напішыце кароткі, стрыманы пераказ артыкула пра гісторыю і архітэктуру населенага пункта (максымум 4 сказы!) у стылі турыстычнага даведніка. Калі артыкул пра горад, які цяпер знаходзіцца на тэрыторыі Летувы, не згадвайце сучасную дзяржаву і акцэнтуйце ўвагу на яго гістарычным беларускім складніку і значэнні для беларускай культуры. Тэкст павінен быць інфарматыўным і прызначаным для тых, хто не знаёмы з гарадамі Беларусі.`;
